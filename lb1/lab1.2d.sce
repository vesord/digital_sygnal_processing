...
cur_axes.data_bounds = [0, A * -1.2; 0.13, A * 1.2];	//	... ylim() in MathLab
...
test1 = (10.6902 - 0.2672 * N) * log(0.00001) + 123.075 - 1.0769 * N;
disp(test1);

test2 = (10.6902 - 0.2672 * N) * log(0.75001) + 123.075 - 1.0769 * N;
disp(test2);
